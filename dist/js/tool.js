...
Nova.booting(function (Vue, router, store) {
    Vue.component('nova-auditing', __webpack_require__(2));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        ...
        axios.get('/nova-vendor/nova-auditing/' + this.auditableResourceName + '/' + this.resourceId).then(function (_ref) {
            var _ref$data = _ref.data,
                ...
                changes = _ref$data.changes;

            _this.currentFields = current;
            _this.previousFields = previous;
    ...
    methods: {
        ...
        changed: function changed(field) {
            return !!this.changes.find(function (item) {
                return field.attribute === item;
            });
        }
    }
});
      ...
      [
        ...
        _c("card", { staticClass: "mb-6 py-3 px-6" }, [
          _c("div", { staticClass: "flex mb-4" }, [
            _c(
              "div",
              { staticClass: "w-1/2 h-auto before" },
              [
                _c(
                  "heading",
                  { staticClass: "mb-3 text-center", attrs: { level: 3 } },
                  [
                    _c(
                      "span",
                      {
                        staticClass:
                          "inline-block bg-50 rounded-full px-3 py-1 text-sm font-semibold  mr-2"
                      },
                ...
                _c(
                  ...
                  _vm._l(_vm.previousFields, function(field, index) {
                    return _c(_vm.resolveComponentName(field), {
                      key: index,
                      tag: "component",
                      class: {
                        "remove-bottom-border":
                          index == _vm.previousFields.length - 1,
                        previous: _vm.changed(field)
                      },
                      attrs: {
            ...
            _c(
              ...
              [
                ...
                _c(
                  "card",
                  { staticClass: "mb-6 py-3 px-6" },
                  _vm._l(_vm.currentFields, function(field, index) {
                    return _c(_vm.resolveComponentName(field), {
                      key: index,
                      tag: "component",
                      class: {
                        "remove-bottom-border":
                          index == _vm.currentFields.length - 1,
                        current: _vm.changed(field)
                      },
                      attrs: {
                        "resource-name": _vm.auditableResourceName,
                        "resource-id": _vm.auditableResourceId,
